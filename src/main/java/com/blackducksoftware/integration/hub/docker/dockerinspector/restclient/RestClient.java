...
public class RestClient {
    ...
    public String getBdio(final String imageInspectorUrl, final String containerPathToTarfile, final boolean cleanup) throws IntegrationException, MalformedURLException {
