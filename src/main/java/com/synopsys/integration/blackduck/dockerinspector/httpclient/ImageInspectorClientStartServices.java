...
public class ImageInspectorClientStartServices implements ImageInspectorClient {
    ...
    private ContainerDetails ensureServiceReady(final IntHttpClient httpClient, final URI imageInspectorUri, final ImageInspectorOsEnum inspectorOs) throws IntegrationException, InterruptedException, IOException {
