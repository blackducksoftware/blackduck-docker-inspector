...
can pull, save, and inspect any image that is pulled using a *docker pull* command.
...
By default, ${solution_name} starts, uses, and then stops or removes either one or two containerized
