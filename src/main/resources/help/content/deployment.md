...
Deployment notes: Download: curl -O ${source_raw_content_url_base}/${source_repo_organization}/${project_name}/master/deployment/circleci/config.yml
...
To use environment variables, and to call ${solution_name} from Detect,
...
and to call ${solution_name} from Detect, you must
