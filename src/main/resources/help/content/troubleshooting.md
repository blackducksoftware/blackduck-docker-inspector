...
Docker image as a .tar file on your computer by
using *docker cp* to copy it into the container, and run ${solution_name} on that .tar file.
...
Solution/workaround: Set the umask value to 022 when running ${solution_name}. The cause could be an umask value
