...
abstract class Extractor {
    ...
    void extract(BdioWriter bdioWriter, ExtractionDetails extractionDetails, String codeLocationName, String projectName, String version) {
        ...
        BdioExternalIdentifier bdioId = bdioPropertyHelper.createExternalIdentifier(extractionDetails.operatingSystem.forge, externalId)
        // TODO: the bdioToString() should be an id like: data:ubuntu/latest, generated by integration-bdio; see IDOCKER-177
        BdioProject projectNode = bdioNodeFactory.createProject(projectName, version, bdioId.toString(), extractionDetails.operatingSystem.forge, externalId)
