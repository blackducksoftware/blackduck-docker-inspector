...
class RuntimeOsTest {
    ...
    public void test() {
        ...
        assertEquals("hub-inspector-centos", osMapper.getDockerImageName(OperatingSystemEnum.CENTOS))
        ...
        assertEquals("hub-inspector", osMapper.getDockerImageName(OperatingSystemEnum.UBUNTU))
