...
class RuntimeOsTest {
    ...
    public void test() {
        ...
        assertEquals("hub-docker-centos", osMapper.getDockerImageName(OperatingSystemEnum.CENTOS))
        ...
        assertEquals("hub-docker-ubuntu", osMapper.getDockerImageName(OperatingSystemEnum.UBUNTU))
