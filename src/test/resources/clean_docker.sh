...
docker rmi blackducksoftware/hub-docker-inspector:1.1.2
docker rmi blackducksoftware/hub-docker-inspector-centos:1.1.2
docker rmi blackducksoftware/hub-docker-inspector-alpine:1.1.2
