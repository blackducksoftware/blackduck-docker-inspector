...
# to inspect multiple docker images concurrently (without starting /
...
# it's not already running), and send it 3 concurrent requests to inspect
# alpine:latest
#
...
# Get the DI jar
curl -O https://test-repo.blackducksoftware.com:443/artifactory/bds-integrations-release/com/synopsys/integration/blackduck-docker-inspector/${dockerInspectorVersion}/blackduck-docker-inspector-${dockerInspectorVersion}.jar
